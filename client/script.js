...
const repeatMyParam = () => {
    let repeat1 = document.getElementById('repeat-text')

    return axios.get('http://localhost:3000/repeat/I-AM-STRUGGLING-LOL')
.then(res =>{
    repeat1.textContent = res.data
...
// CODE HERE
 const f8 = () => axios.get('http:localhost:3000/query-test?ThisIsMyQuerySample=SUCCESS')
.then(({data}) => console.log(data))
document.getElementById('query-button').addEventListener(`click`,f8)
////////////////
//INTERMEDIATE//
////////////////
